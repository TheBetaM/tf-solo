...
void CBaseLesson::Init()
{
    ...
    m_iSubType = LESSON_SUBTYPE_BASIC;
...
#define LESSON_VARIABLE_FACTORY                                                                                        \
    ...
    LESSON_VARIABLE_MACRO(SUBTYPE, m_iSubType, int)                                                                    \
...
void CScriptedIconLesson::InitFromKeys(KeyValues *pKey)
{
    ...
    static int s_nLessonSubTypeSymbol = KeyValuesSystem()->GetSymbolForString("subtype");
    ...
    for (pSubKey = pKey->GetFirstSubKey(); pSubKey; pSubKey = pSubKey->GetNextKey())
    {
        if (pSubKey->GetNameSymbol() == s_nLessonSubTypeSymbol)
        {
            m_iSubType = LessonSubType(pSubKey->GetInt());
        }
        else if (pSubKey->GetNameSymbol() == s_nInstanceTypeSymbol)
        {
