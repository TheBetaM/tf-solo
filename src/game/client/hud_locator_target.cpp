...
class CLocatorPanel : public vgui::EditablePanel
{
  ...
  private:
    CPanelAnimationVar(vgui::HFont, m_hCaptionFont, "font", "MatchmakingDialogMenuLarge");// "InstructorTitle");
    CPanelAnimationVar(vgui::HFont, m_hCaptionFont_ss, "font", "MatchmakingDialogMenuLarge");// "InstructorTitle_ss");
    CPanelAnimationVar(vgui::HFont, m_hCaptionGlowFont, "font", "MatchmakingDialogMenuLarge");// "InstructorTitleGlow");
    CPanelAnimationVar(vgui::HFont, m_hCaptionGlowFont_ss, "font", "MatchmakingDialogMenuLarge");// "InstructorTitleGlow_ss");

    CPanelAnimationVar(vgui::HFont, m_hButtonFont, "font", "GameUIButtons");//"InstructorButtons");

    CPanelAnimationVar(vgui::HFont, m_hButtonFont_ss, "font", "GameUIButtons");// "InstructorButtons_ss");
    CPanelAnimationVar(vgui::HFont, m_hKeysFont, "font", "MatchmakingDialogMenuLarge");//"InstructorKeyBindings");
...
void CLocatorPanel::DrawIndicatorArrow(int x, int y, int iconWide, int iconTall, int textWidth, int direction)
{
    ...
    switch (direction)
    {
    case DrawArrowEnum::LOCATOR_DRAW_ARROW_LEFT:
    ...
    case DrawArrowEnum::LOCATOR_DRAW_ARROW_RIGHT:
    ...
    case DrawArrowEnum::LOCATOR_DRAW_ARROW_UP:
    ...
    case DrawArrowEnum::LOCATOR_DRAW_ARROW_DOWN:
