...
extern ConVar tf_oobe_hints_base;
extern ConVar tf_oobe_hints_mod;
...
ConVar gameinstructor_verbose(
    "gameinstructor_verbose", "0", FCVAR_CHEAT,
...
#endif
    {
        Q_snprintf(szFilename, sizeof(szFilename), "cfg/solo/game_instructor_counts.txt");
    }
...
bool C_GameInstructor::WriteSaveData()
{
    ...
    {
        Q_snprintf(szFilename, sizeof(szFilename), "cfg/solo/game_instructor_counts.txt");
        //filesystem->CreateDirHierarchy("cfg/solo", "MOD");
    }
...
bool C_GameInstructor::OpenOpportunity(CBaseLesson *pLesson)
{
    ...
    if ( pRootLesson->GetSubType() == LESSON_SUBTYPE_TF2 && !tf_oobe_hints_base.GetBool() )
    {
        delete pLesson;
        return false;
    }
    else if ( pRootLesson->GetSubType() == LESSON_SUBTYPE_TFSOLO && !tf_oobe_hints_mod.GetBool() )
    {
        delete pLesson;
        return false;
    }
