...
ConVar cam_idealyaw( "cam_idealyaw", "0", 0 );	 // thirdperson yaw
ConVar cam_idealpitch( "cam_idealpitch", "0", 0 );	 // thirperson pitch
ConVar cam_idealdist( "cam_idealdist", "150", 0 );	 // thirdperson distance
ConVar cam_idealdistright( "cam_idealdistright", "0", 0 );	 // thirdperson distance
ConVar cam_idealdistup( "cam_idealdistup", "0", 0 );	 // thirdperson distance
